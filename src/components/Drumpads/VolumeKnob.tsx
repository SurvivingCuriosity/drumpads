    ...
    return (
        <div className="relative w-8 rounded-md bg-neutral-900">
            ...
            <input
                ...
                value={value}
            />
            <img onClick={handleVolumeIconClick} src={value === '0' ? no_volume_icon : parseInt(value) <= 50 ? volume_icon : volume_highicon} alt="volume" className="absolute bottom-0 left-1/2 -mb-2 size-6 -translate-x-1/2" />
        </div>
    )
}
